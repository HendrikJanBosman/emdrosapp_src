#### KERNEL CONFIGURATION FILE FOR ESPERANTO DATABASES ###
import os.path
import sys
import platform
...
DEFAULT_KERNEL_CFG = 'lamentoj.cfg'
...
if platform.system() == 'Linux':
    ...
    DEFAULT_DATABASE = 'lamentoj'
    DEFAULT_USR      = 'emdf'
    DEFAULT_PWD      = 'changeme'

    EMDROSAPP_DIR = HOME_DIR + 'ownCloud/git/EmdrosApplication/'
    PROJECT_DIR   = EMDROSAPP_DIR + 'emdrosapp_data/esperanto/'
...
### SETUP OTHER SYSTEMS; COPY AND EDIT FROM 'Linux' ####
    ...
    PROJECT_DIR   = EMDROSAPP_DIR + 'esperanto/'
